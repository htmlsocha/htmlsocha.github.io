(function (e) {
    ...
    0: function (e, s, d) {
        ...
        var o = d("2b0e"), t = function () {
            ...
            }, [e._v("Zobacz wyniki ")]) : e._e()])]) : e._e(), 1 == e.summaryscreenshown ? d("div", {staticClass: "bg-white p-12 rounded-lg shadow-lg w-full mt-8"}, [1 == e.notrandom ? d("div", [d("h1", [e._v(" Twój wynik to:")]), d("p", [e._v(" " + e._s(e.points) + " / " + e._s(e.indexmax - e.pointsstart))])]) : d("div", [d("h1", [e._v(" Twój wynik to:")]), d("p", [e._v(" " + e._s(e.points) + " / 20")]), 20 / this.points <= 2 ? d("p", {staticClass: "bg-green-50 border border-green-500 text-green-900 placeholder-green-700 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5 dark:bg-green-100 dark:border-green-400"}, [e._v("🎉🎉🎉 Zdaned!!!!!! 🎉🎉🎉")]) : d("p", {staticClass: "bg-red-50 border border-red-500 text-red-900 placeholder-red-700 text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5 dark:bg-red-100 dark:border-red-400"}, [e._v("😿😿😿 Niezdaned, weź się w garść pociesz kotka i zdaj następne oki? :( 😿😿😿")])])]) : e._e()]) : e._e()])
